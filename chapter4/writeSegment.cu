...
int main(int argc, char **argv)
{
    ...
    printf("warm up execution time: %f ms\n", elapsedTime);
    ...
    printf("writeOffset execution time: %f ms\n", elapsedTime);
    ...
    timer.stop();
    elapsedTime = timer.elapsedms();
    printf("writeOffsetUnroll2 execution time: %f ms\n", elapsedTime);
    ...
    timer.stop();
    elapsedTime = timer.elapsedms();
    printf("writeOffsetUnroll4 execution time: %f ms\n", elapsedTime);
